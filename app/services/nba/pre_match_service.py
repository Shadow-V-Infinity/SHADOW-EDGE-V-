...
class ShadowEdgePreMatchService:
    ...
    def __init__(self):
        ...
        self._team_stats_cache = {}  # cache pour éviter les appels répétés
    ...
    def get_today_games(self, day: str = None):
        """
        Retourne les matchs du jour avec stats réelles.
        ...
        try:
            ...
            result = []
            for g in games:
                home_name = g["homeTeam"]["teamTricode"]  # ex: "BOS"
                away_name = g["awayTeam"]["teamTricode"]

                home_full = g["homeTeam"]["teamName"]  # ex: "Celtics"
                away_full = g["awayTeam"]["teamName"]

                # Stats depuis nba_api league dashboard
                home_s = league_stats.get(home_name, {})
                away_s = league_stats.get(away_name, {})
                ...
                result.append({
                    ...
                    # Stats domicile
                    "home": {
                        "pace":       home_s.get("pace"),
                        "off_rating": home_s.get("off_rating"),
                        "def_rating": home_s.get("def_rating"),
                        "form":       home_trends.get("avg_total_points"),
                        "wins":       home_s.get("wins"),
                        "losses":     home_s.get("losses"),
                    },
                    # Stats extérieur
                    "away": {
                        "pace":       away_s.get("pace"),
                        "off_rating": away_s.get("off_rating"),
                        "def_rating": away_s.get("def_rating"),
                        "form":       away_trends.get("avg_total_points"),
                        "wins":       away_s.get("wins"),
                        "losses":     away_s.get("losses"),
                    },
