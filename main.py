...
for sport, path in [
    ("live",       "frontend/live"),
    ("pre_match",  "frontend/pre_match"),
    ("basketball", "frontend/basketball"),
    ("tennis",     "frontend/tennis"),
    ("hockey",     "frontend/hockey"),
    ("rugby",      "frontend/rugby"),
]:
    if os.path.exists(path):
        app.mount(f"/{sport}", StaticFiles(directory=path, html=True), name=sport)
